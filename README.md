...
## 🔹 Live Demo (MVP)
[Click here to access the live webpage](https://kamraanmulla.github.io/Silent-SOS/)



## 🔹 Features
- Single SOS button for quick emergency requests  
- 3-second countdown before sending SOS to avoid false triggers  
- Cancel button to abort the alert  
